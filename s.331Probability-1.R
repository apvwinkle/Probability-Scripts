...
### Binomial
# X = number of correct guesses out of n=10 5-response multiple choice Q's
...
### Uniform: Inverse transform on Bob & Betty Gas
n = 1000     #sample size
u = runif(n) #random numbers on [0,1]
hist(u, prob=TRUE)
x = -log(1-u)/0.6
hist(x, prob=TRUE)
lines(0:12, dexp(0:12, rate=0.6), col='red')
